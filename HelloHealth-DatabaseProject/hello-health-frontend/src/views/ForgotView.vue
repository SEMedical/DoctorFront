<template>
    <el-form :label-position="'top'" label-width="60px" :model="forgotPasswordCredential" class="forgotForm">
        ...
        <el-form-item label="新密码" v-bind:class="{ error: isError }">
            <el-input v-model="forgotPasswordCredential.new_password" type="password" @click="clearErrorBorder"
                show-password />
        </el-form-item>
